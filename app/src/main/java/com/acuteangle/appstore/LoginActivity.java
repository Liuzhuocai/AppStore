    ...
    private void authorize(Platform plat, int type) {
        switch (type) {
            ...
            case 3:
                ...
                break;
            case 4:
                showProgressDialog(getString(R.string.opening_facebook));
                break;
            case 5:
                showProgressDialog(getString(R.string.opening_twitter));
                break;
        }
...
//部分没有封装的字段可以通过键值获取，例如下面微信的unionid字段
                Log.d("liuzuo","accessToken:"+accessToken+","+"openId:"+openId+","+"userName:"+userName+"userId:"+userId+"userIcon:"+userIcon+"userGender:"+userGender);
