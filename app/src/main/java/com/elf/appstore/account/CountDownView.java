...
public class CountDownView extends android.support.v7.widget.AppCompatTextView implements View.OnClickListener {
    ...
    public void onClick(View v) {
        ...
        mPresenter.sendPhoneNum(mUser);
    }

    public boolean checkUser() {
        VerifyUserLogImpl verifyUserLog = new VerifyUserLogImpl(true);
        boolean isVerify = verifyUserLog.verifyPhoneOrEmail(mUser);
        ...
        return new VerifyUserLogImpl( true).verifyPhoneOrEmail(mUser);
    ...
    public void setCaptchaListener(LoginLoader.CaptchaListener captchaListener, LoginPresenter presenter) {
